...
const merge = (rs1,rs2,rs3,rs4,rs5) => {
    let result = [];
    if(rs1!=null){
    rs1.forEach((obj) => {
        result.push(obj);
    ...
    try {
        const response = await fetch(url, {
            headers: {
                ...
                'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..UsKpYuBnIxsfO2iqDEevQYRvzetC3sXAtGSz2zBzVJ8'
            },
            method: "GET",
        });
        if (!response.ok) {
...
router.get("/:categoryname/products",async(req,res)=>{
    ...
    const result=merge(result1,result2,result3,result4,result5);
